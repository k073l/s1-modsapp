...
namespace ModsApp
{
    public class UITheme
    {
        ...
        public readonly Color BgCategory = new Color(0.18f, 0.18f, 0.22f, 1f);
        public readonly Color BgInput = Color.white;
        ...
        public readonly Color TextSecondary = new Color(0.70f, 0.70f, 0.70f, 0.75f);
        public readonly Color InputPrimary = Color.black;
        public readonly Color InputSecondary = new Color(0.50f, 0.50f, 0.50f, 1f);
        ...
        public readonly Color ErrorColor = new Color(0.95f, 0.20f, 0.20f, 1f);

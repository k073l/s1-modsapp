...
namespace ModsApp
{
    public static class UIHelper
    {
        public static string SanitizeName(string input)
        {
            ...
            return Regex.Replace(input, @"[^\w\d_]", "_");
        }
        
        public static void DumpRect(string id, RectTransform rt)
        {
            if (rt == null) { MelonLogger.Msg($"{id}: NULL"); return; }
            MelonLogger.Msg($"{id}: anchorMin={rt.anchorMin}, anchorMax={rt.anchorMax}, offsetMin={rt.offsetMin}, offsetMax={rt.offsetMax}, pivot={rt.pivot}, sizeDelta={rt.sizeDelta}, localPos={rt.localPosition}, siblingIndex={rt.GetSiblingIndex()}");
        }
        
        public static void ForceRectToAnchors(RectTransform rt, Vector2 anchorMin, Vector2 anchorMax, Vector2? offsetMin = null, Vector2? offsetMax = null, Vector2? pivot = null)
        {
            if (rt == null) return;
        ...
        public static void SetupButton(Button button, UITheme theme, Action onClick)
        {
            ...
            colors.highlightedColor = new Color(theme.AccentSecondary.r + 0.1f, theme.AccentSecondary.g + 0.1f, theme.AccentSecondary.b + 0.1f, 1f);
        ...
        public static void ConfigureButtonText(RectTransform rt, Vector2 anchorMin, Vector2 anchorMax, float leftOffset, float rightOffset, float topOffset, float bottomOffset)
        {
            rt.anchorMin = anchorMin;
            rt.anchorMax = anchorMax;
